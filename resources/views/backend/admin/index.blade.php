                            ...
                            <table class="table table-hover">
                                ...
                                @forelse($admins as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @_can('delete_admins')
                                                @if($item->type=='moderator')             {{-- is not super admin--}}
                                                ...
                                                @else
                                                    <button class="btn btn-sm btn-danger" disabled  title="{{__('dashboard.can_not_delete_this')}}">
                                                        <i class="fa fa-trash"></i>
                                                        {{__('dashboard.delete')}}</button>
                                                @endif
                                            @_cant
                                            ...
                                            @_can('update_admins')
                                                @if($item->type=='moderator')             {{-- is not super admin--}}
                                                    <a href="{{route('admin.edit',$item->id)}}" class="btn btn-sm btn-success">
                                                        ...
                                                        {{__('dashboard.edit')}}</a>
                                                @else
                                                    <button disabled class="btn btn-sm btn-success" title="{{__('dashboard.can_not_edit_this')}}">
                                                        <i class="fa fa-edit"></i>
