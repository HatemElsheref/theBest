    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">@lang('dashboard.edit_admin')</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title">@lang('dashboard.edit_admin')</h3>
                        </div><!-- /.box-header -->

                    @include('backend.shared.error')

                    <!-- form start -->
                        <form role="form" method="post" action="{{route('admin.update',$admin->id)}}" enctype="multipart/form-data">
                           @csrf
                            @method('put')
...
{{--                                    <img id="tmp_image" src="{{image($admin->photo)}}" class="img-circle" style="width: 40px;height: 40px;" onclick="document.getElementById('avatar').click()">--}}
