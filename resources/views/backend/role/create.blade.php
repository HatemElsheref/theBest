    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">@lang('dashboard.add_role')</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">@lang('dashboard.add_role')</h3>
                        </div><!-- /.box-header -->
                        ...
                        <form role="form" method="post" action="{{route('role.store')}}">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="@lang('dashboard.enter') @lang('dashboard.role_name')" value="{{old('name')}}">
                                </div>

                                <div class="form-group">
                                    <label for="first_name">@lang('dashboard.role_description')</label>
                                    <input type="text" class="form-control" name="description" placeholder="@lang('dashboard.enter') @lang('dashboard.role_description')" value="{{old('description')}}">
                                </div>
                                                                ...
                                                                <div class="form-group pull-right" style="margin-left: 10px">
                                                                    <div class="checkbox-inline">
                                                                        ...
                                                                        <input type="checkbox" id="{{strtolower($operations[$crud_operation].'_'.$key)}}" value="{{strtolower($operations[$crud_operation].'_'.$key)}}" name="permissions[]"
                                                                            {{(in_array(strtolower($operations[$crud_operation].'_'.$key),(array)old('permissions')))?'checked':''}}>
